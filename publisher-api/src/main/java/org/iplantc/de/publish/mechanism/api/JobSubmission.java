...
public class JobSubmission {
    ...
    /**
     * The job name. This field should contain a brief ({@code MAX_JOB_NAME_LENGTH}
     * characters maximum) description of the job. Duplicate job names are permitted,
     * but it is helpful for the job name to be unique.
     */
     ...
     * create a subdirectory of the selected output directory, with a name
     * that is generated from the job name and the job submission time.
     */
    ...
    /**
     * @param builder the job submission builder.
     */
    ...
    public static class JobSubmissionBuilder {
         ...
         * absolutely necessary, for the job name to be unique. This field
         * is required.
         *
        ...
        /**
         * Sets the ID of the app to use when a job is submitted. This field
         * is required and has a maximum length of {@code MAX_APP_ID_LENGTH}
         * characters.
         *
         ...
         * {@code true}, a new subdirectory with a named based on the job
         * name and the job submission time will be created. This field
         * defaults to {@code true} if not specified.
         *
         * @param create {@code true} if a subdirectory should be created.
         * @return the job submission builder.
         */
         ...
         * generated during job execution should be archived in the job
         * output directory (recommended). This field defaults to {@code true}
         * if not specified.
         *
         * @param archive {@code true} if the log files should be archived.
         * @return the job submission builder.
         */
         ...
         *
         * @param notify {@code true} if the user should be notified.
         * @return the job submission builder.
         */
         ...
         *
         * @throws NullPointerException if the job name is null.
         * @throws IllegalArgumentException if the job name is empty or too long.
         */
        private void validateJobName() {
            ...
            if (name.length() == 0) {
                throw new IllegalArgumentException("the job name may not be empty");
            }
            if (name.length() > MAX_JOB_NAME_LENGTH) {
                String msg = "the job name may not be more than " + MAX_JOB_NAME_LENGTH
                        + " characters long";
         ...
         *
         * @throws NullPointerException if the app ID is null.
         * @throws IllegalArgumentException if the app ID is empty or too long.
         */
        private void validateAppId() {
            ...
            if (appId.length() == 0) {
                throw new IllegalArgumentException("the app ID may not be empty");
            }
         ...
         *
         * @throws NullPointerException if the output directory is null.
         * @throws IllegalArgumentException if the output directory is empty.
         */
        private void validateOutputDir() {
            if (outputDir == null) {
                throw new NullPointerException("the output directory may not be null");
            }
            if (outputDir.length() == 0) {
                throw new IllegalArgumentException("the output directory may not be empty");
            }
        }
    }
